...
_Auto-generated by AD-SDLC PR Review Agent_`;
  ...
  private async createCIFixHandoff(
    ...
    return {
      ...
      originalIssue: implResult.githubIssue !== undefined
        ? `#${String(implResult.githubIssue)}`
        : implResult.issueId,
   ...
   */
  public shouldDelegateToCIFixer(prNumber: number, retryCount: number): boolean {
    return (
      this.config.enableCIFixDelegation &&
      retryCount >= this.config.maxCIRetries
    );
  }
